...
describe('Reader', () => {
  ...
  describe('#getUint16()', () => {
    ...
    it('should return a big-endian Uint16 value', () => {
      ...
      assert.throws(() => reader.getUint16())
    })
    it('should return a little-endian Uint16 value when ' +
      ...
      assert.throws(() => reader.getUint16(true))
    })
  })
  describe('#getUint32()', () => {
    it('should throw for wrong arguments', () => {
  ...
  describe('#getInt16()', () => {
    ...
    it('should return a little-endian Int16 value when ' +
      ...
      assert.throws(() => reader.getInt16(true))
    })
  })
  describe('#getInt32()', () => {
    it('should throw for wrong arguments', () => {
  ...
  describe('#getFloat32()', () => {
    ...
    it('should return a big-endian Float32 value', () => {
      ...
      assert.throws(() => reader.getFloat32())
    })
    it('should return a little-endian Float32 value when ' +
      ...
      assert.throws(() => reader.getFloat32(true))
    })
  })
  describe('#getFloat64()', () => {
    it('should throw for wrong arguments', () => {
    ...
    it('should return a big-endian Float64 value', () => {
      ...
      assert.throws(() => reader.getFloat64())
    })
    it('should return a little-endian Float64 value when ' +
      ...
      assert.throws(() => reader.getFloat64(true))
    })
  })
  describe('#data', () => {
