...
def_layer_class!(
    ...
    header2: &RDELAY_ATTR,
    header2: &RDELAY_SEC_ATTR,
    header2: &RDELAY_FRA_ATTR,
    header2: &RDISP_ATTR,
    header2: &RDISP_SEC_ATTR,
    header2: &RDISP_FRA_ATTR,
    header2: &REFTS_ATTR,
    header2: &REFTS_SEC_ATTR,
    header2: &REFTS_FRA_ATTR,
    header2: &ORITS_ATTR,
    header2: &ORITS_SEC_ATTR,
    header2: &ORITS_FRA_ATTR,
    header2: &RECTS_ATTR,
    header2: &RECTS_SEC_ATTR,
    header2: &RECTS_FRA_ATTR,
    header2: &TRATS_ATTR,
    header2: &TRATS_SEC_ATTR,
    header2: &TRATS_FRA_ATTR
);
